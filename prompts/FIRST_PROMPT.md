...
Prefer source-checking through the WordPress.com public API rather than scraping `kekrilo.gr` directly. The custom domain may return TLS/403 issues to command-line fetches, while the WordPress.com API is clean and structured:
